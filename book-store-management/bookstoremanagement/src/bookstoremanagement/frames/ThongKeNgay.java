 ...
 * @author songnguyen
 */
public class ThongKeNgay extends javax.swing.JFrame {
    ...
    public ThongKeNgay() {
        initComponents();
        BUSThangNam qlBUS = new BUSThangNam();
        HienThiThongKeThangNam.AddTable(qlBUS.getDS(), TKtable);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongKeNgay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongKeNgay().setVisible(true);
            }
        });
    }
